...
export default function AppFooter(props) {
  return (
    <div>
      <Navbar
        className="app-bg-primary border-secondary border-top position-relative"
        dark
        expand="md"
      >
        <div className="w-100 d-flex justify-content-center">
          <span style={{ fontSize: "12px" }} className="my-2 text-muted">
            Agile Express Application Developed for JCP Internship by Mert Koca
          </span>
          <span className="position-absolute end-0 me-5 clickable">
            <a
              href="https://external.obss.com.tr/bitbucket/projects/JCP22/repos/mert.koca/browse"
              title="Go To Project Source"
            >
              <svg
                width={"16px"}
                height={"16px"}
